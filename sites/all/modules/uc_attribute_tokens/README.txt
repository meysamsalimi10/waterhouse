...
them. Thus it's solely a matter of convenience that these two token
...
an administrator to calculate price (or other product properties such as
weight) based on attributes, using custom PHP code.
